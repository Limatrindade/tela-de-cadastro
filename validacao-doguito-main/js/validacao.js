...
const mensagensDeErro = {
    ...
    senha: {
        ...
        patternMismatch: 'A senha deve conter pelo menos uma letra maiúscula, um dígito, e ter entre 6 a 13 caracteres sem espaços.'
    }, 
    dataNascimento: {
...
function checaDigitoVerificador(cpf, multiplicador) {
    ...
    const digitoVerificador = cpf.chartAt(multiplicador - 1)
